...
var _user$project$Snake$moveSnake = F2(
	function (next, model) {
		var sn1 = {ctor: '::', _0: next, _1: model.snake};
		var sn2 = (!_elm_lang$core$Native_Utils.eq(next, model.foodPosition)) ? A2(
			_elm_lang$core$List$take,
			_elm_lang$core$List$length(sn1) - 1,
			sn1) : sn1;
		return _elm_lang$core$Native_Utils.update(
			model,
			{snake: sn2});
	});
var _user$project$Snake$updateDirection = function (model) {
	var _p0 = model.directionChange;
	if (_p0.ctor === 'Just') {
		return _elm_lang$core$Native_Utils.update(
			model,
			{direction: _p0._0, directionChange: _elm_lang$core$Maybe$Nothing});
	} else {
		return model;
	}
};
var _user$project$Snake$nextPosition = F2(
...
var _user$project$Snake$head = function (snake) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		{ctor: '_Tuple2', _0: 0, _1: 0},
		_elm_lang$core$List$head(snake));
};
var _user$project$Snake$cellSize = 28;
var _user$project$Snake$columnCount = 22;
var _user$project$Snake$rowCount = 22;
var _user$project$Snake$isLoosingPosition = F2(
	function (_p3, model) {
		var _p4 = _p3;
		var _p6 = _p4._1;
		var _p5 = _p4._0;
		return A2(
			...
			model.snake) || ((_elm_lang$core$Native_Utils.cmp(_p5, 0) < 0) || ((_elm_lang$core$Native_Utils.cmp(_user$project$Snake$columnCount, _p5) < 1) || ((_elm_lang$core$Native_Utils.cmp(_p6, 0) < 0) || (_elm_lang$core$Native_Utils.cmp(_user$project$Snake$rowCount, _p6) < 1))));
	});
var _user$project$Snake$Model = F5(
	function (a, b, c, d, e) {
		return {foodPosition: a, snake: b, direction: c, directionChange: d, lost: e};
	});
var _user$project$Snake$Right = {ctor: 'Right'};
var _user$project$Snake$init = {
	ctor: '_Tuple2',
	_0: {
		foodPosition: {ctor: '_Tuple2', _0: 12, _1: 17},
		snake: {
			ctor: '::',
		...
		directionChange: _elm_lang$core$Maybe$Nothing,
		lost: false
	},
...
var _user$project$Snake$keyMappings = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 38, _1: _user$project$Snake$Up},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 40, _1: _user$project$Snake$Down},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 37, _1: _user$project$Snake$Left},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 39, _1: _user$project$Snake$Right},
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$Snake$reverse = function (direction) {
	var _p7 = direction;
	switch (_p7.ctor) {
		case 'Up':
			return _user$project$Snake$Down;
		case 'Down':
			return _user$project$Snake$Up;
		case 'Right':
			return _user$project$Snake$Left;
		default:
			return _user$project$Snake$Right;
	}
};
var _user$project$Snake$keyToDirection = F2(
	function (keyCode, currentDirection) {
		var _p8 = A2(_elm_lang$core$Dict$get, keyCode, _user$project$Snake$keyMappings);
		if (_p8.ctor === 'Just') {
			var _p9 = _p8._0;
			return _elm_lang$core$Native_Utils.eq(
				_p9,
				_user$project$Snake$reverse(currentDirection)) ? currentDirection : _p9;
		} else {
			return currentDirection;
		}
	});
var _user$project$Snake$Event = function (a) {
	return {ctor: 'Event', _0: a};
};
var _user$project$Snake$raiseEvent = function (kind) {
	return A2(
		_elm_lang$core$Task$perform,
		_user$project$Snake$Event,
		_elm_lang$core$Task$succeed(kind));
};
var _user$project$Snake$FoodAppeared = function (a) {
	return {ctor: 'FoodAppeared', _0: a};
};
var _user$project$Snake$moveFood = function () {
	var rowGenerator = A2(_elm_lang$core$Random$int, 0, _user$project$Snake$rowCount - 1);
	var columnGenerator = A2(_elm_lang$core$Random$int, 0, _user$project$Snake$columnCount - 1);
	return A2(
		_elm_lang$core$Random$generate,
		_user$project$Snake$FoodAppeared,
		A2(_elm_lang$core$Random$pair, columnGenerator, rowGenerator));
}();
var _user$project$Snake$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _user$project$Snake$subscriptions = function (model) {
	return _elm_lang$keyboard$Keyboard$downs(_user$project$Snake$KeyDown);
};
var _user$project$Snake$Tick = {ctor: 'Tick'};
var _user$project$Snake$Bite = {ctor: 'Bite'};
var _user$project$Snake$Died = {ctor: 'Died'};
var _user$project$Snake$update = F2(
	function (msg, model) {
		if (model.lost) {
			...
			switch (_p10.ctor) {
				case 'Tick':
					var next = A2(_user$project$Snake$nextPosition, model.snake, model.direction);
					if (A2(_user$project$Snake$isLoosingPosition, next, model)) {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{lost: true}),
							_1: _user$project$Snake$raiseEvent(_user$project$Snake$Died)
						};
					} else {
						var cmd = _elm_lang$core$Native_Utils.eq(next, model.foodPosition) ? _elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: _user$project$Snake$raiseEvent(_user$project$Snake$Bite),
								_1: {
									ctor: '::',
									_0: _user$project$Snake$moveFood,
									_1: {ctor: '[]'}
								}
							}) : _elm_lang$core$Platform_Cmd$none;
						var updatedModel = A2(
							_user$project$Snake$moveSnake,
							next,
							_user$project$Snake$updateDirection(model));
						return {ctor: '_Tuple2', _0: updatedModel, _1: cmd};
					}
				case 'KeyDown':
					var _p11 = model.directionChange;
					if (_p11.ctor === 'Just') {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						var directionChange = A2(_user$project$Snake$keyToDirection, _p10._0, model.direction);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									directionChange: _elm_lang$core$Maybe$Just(directionChange)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
				case 'FoodAppeared':
					var _p14 = _p10._0._1;
					var _p13 = _p10._0._0;
					var _p12 = model.foodPosition;
					var x2 = _p12._0;
					var y2 = _p12._1;
					return (_elm_lang$core$Native_Utils.eq(_p13, x2) || _elm_lang$core$Native_Utils.eq(_p14, y2)) ? {ctor: '_Tuple2', _0: model, _1: _user$project$Snake$moveFood} : {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								foodPosition: {ctor: '_Tuple2', _0: _p13, _1: _p14}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				default:
...
var _user$project$Snake_CanvasView$cell = F3(
	function (color, x, y) {
		var square = _evancz$elm_graphics$Collage$square(_user$project$Snake$cellSize);
		var dy = ((_user$project$Snake$rowCount / 2) - 0.5) - _elm_lang$core$Basics$toFloat(y);
		var dx = (((0 - _user$project$Snake$columnCount) / 2) + 0.5) + _elm_lang$core$Basics$toFloat(x);
		return A2(
			_evancz$elm_graphics$Collage$move,
			{ctor: '_Tuple2', _0: _user$project$Snake$cellSize * dx, _1: _user$project$Snake$cellSize * dy},
			A2(_evancz$elm_graphics$Collage$filled, color, square));
	});
var _user$project$Snake_CanvasView$snake = function (model) {
	return _evancz$elm_graphics$Collage$group(
		A2(
			_elm_lang$core$List$map,
			function (_p0) {
				var _p1 = _p0;
				return A3(_user$project$Snake_CanvasView$cell, _elm_lang$core$Color$blue, _p1._0, _p1._1);
			},
			model.snake));
};
var _user$project$Snake_CanvasView$food = function (model) {
	var _p2 = model.foodPosition;
	var x = _p2._0;
	var y = _p2._1;
	return A3(_user$project$Snake_CanvasView$cell, _elm_lang$core$Color$red, x, y);
};
var _user$project$Snake_CanvasView$view = function (model) {
	var height = _user$project$Snake$cellSize * _user$project$Snake$rowCount;
	var width = _user$project$Snake$cellSize * _user$project$Snake$columnCount;
	var background = A2(
	...
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			height,
			{
				...
				_1: {
					ctor: '::',
					_0: _user$project$Snake_CanvasView$food(model),
					_1: {
						ctor: '::',
						_0: _user$project$Snake_CanvasView$snake(model),
						_1: {ctor: '[]'}
					}
				}
			}));
};
var _user$project$Snake_CanvasView$background = function () {
	var height = _user$project$Snake$cellSize * _user$project$Snake$rowCount;
	var width = _user$project$Snake$cellSize * _user$project$Snake$columnCount;
	return A2(
		_evancz$elm_graphics$Collage$filled,
...
var _user$project$Snake_GridView$cellColor = F3(
	function (model, x, y) {
		return model.lost ? _elm_lang$core$Color$grey : (A2(
			_elm_lang$core$List$member,
			{ctor: '_Tuple2', _0: x, _1: y},
			model.snake) ? _elm_lang$core$Color$blue : (_elm_lang$core$Native_Utils.eq(
			{ctor: '_Tuple2', _0: x, _1: y},
			model.foodPosition) ? _elm_lang$core$Color$red : _elm_lang$core$Color$grey));
	});
var _user$project$Snake_GridView$rgb = function (color) {
...
var _user$project$Snake_GridView$rowStyle = {
	ctor: '::',
...
var _user$project$Snake_GridView$px = function (n) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(n),
		'px');
};
var _user$project$Snake_GridView$gridStyle = function () {
	var gridWidth = _user$project$Snake$columnCount * _user$project$Snake$cellSize;
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'width',
			_1: _user$project$Snake_GridView$px(gridWidth)
		},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'padding', _1: '0'},
...
var _user$project$Snake_GridView$cellStyle = {
	ctor: '::',
	...
	_1: {
		...
		_1: {
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'height',
				_1: _user$project$Snake_GridView$px(_user$project$Snake$cellSize)
			},
			_1: {
				ctor: '::',
				_0: {
...
var _user$project$Snake_GridView$cell = F3(
	function (model, rowIndex, colIndex) {
		var cellRgb = _user$project$Snake_GridView$rgb(
			A3(_user$project$Snake_GridView$cellColor, model, colIndex, rowIndex));
		var styles = {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'background-color', _1: cellRgb},
			_1: _user$project$Snake_GridView$cellStyle
		};
		return A2(
...
var _user$project$Snake_GridView$buildRow = F2(
	function (model, rowIndex) {
		var range = A2(_elm_lang$core$List$range, 0, _user$project$Snake$columnCount - 1);
		var buildCell = function (colIndex) {
			return A3(_user$project$Snake_GridView$cell, model, rowIndex, colIndex);
		};
		var cells = A2(_elm_lang$core$List$map, buildCell, range);
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(_user$project$Snake_GridView$rowStyle),
					_1: {ctor: '[]'}
				}
			},
			cells);
	});
var _user$project$Snake_GridView$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(_user$project$Snake_GridView$gridStyle),
				_1: {ctor: '[]'}
			}
		},
		A2(
			_elm_lang$core$List$map,
			function (rowIndex) {
				return A2(_user$project$Snake_GridView$buildRow, model, rowIndex);
			},
			A2(_elm_lang$core$List$range, 0, _user$project$Snake$rowCount - 1)));
};

var _user$project$Main$row = function (component) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Main$rowLayout = function (components) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(_elm_lang$core$List$map, _user$project$Main$row, components));
};
var _user$project$Main$statusPart = F2(
...
var _user$project$Main$record = function (model) {
	return A2(
		_elm_lang$html$Html$h1,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('status-part'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(model.record)),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$modelInspector = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'hidden', _1: !model.debug},
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Main$shouldAdvance = function (model) {
	...
	return _elm_lang$core$Native_Utils.eq(
		A2(_elm_lang$core$Basics_ops['%'], model.time, tickTime),
		0);
};
var _user$project$Main$tickTime = _elm_lang$core$Time$inMilliseconds(10);
var _user$project$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {snakeModel: a, viewMode: b, score: c, record: d, speed: e, debug: f, time: g};
	});
var _user$project$Main$Mindblowing = {ctor: 'Mindblowing'};
var _user$project$Main$Fast = {ctor: 'Fast'};
var _user$project$Main$Slow = {ctor: 'Slow'};
var _user$project$Main$Canvas = {ctor: 'Canvas'};
var _user$project$Main$Grid = {ctor: 'Grid'};
var _user$project$Main$SnakeMsg = function (a) {
	return {ctor: 'SnakeMsg', _0: a};
};
var _user$project$Main$init = function () {
	var _p1 = _user$project$Snake$init;
	var sModel = _p1._0;
	var cmd = _p1._1;
	return {
		ctor: '_Tuple2',
		_0: {snakeModel: sModel, viewMode: _user$project$Main$Canvas, score: 0, record: 0, speed: _user$project$Main$Fast, debug: false, time: 0},
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$SnakeMsg, cmd)
	};
}();
		...
		switch (_p2.ctor) {
			case 'Clock':
				var updatedModel = _elm_lang$core$Native_Utils.update(
					model,
					{time: model.time + 1});
				if (_user$project$Main$shouldAdvance(updatedModel)) {
					var _p3 = A2(_user$project$Snake$update, _user$project$Snake$Tick, model.snakeModel);
					var sModel = _p3._0;
					var cmd = _p3._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{snakeModel: sModel, time: model.time + 1}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$SnakeMsg, cmd)
					};
				} else {
			...
			default:
				if (_p2._0.ctor === 'Event') {
					if (_p2._0._0.ctor === 'Bite') {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
						...
						var _p4 = _user$project$Snake$init;
						var sModel = _p4._0;
						var cmd = _p4._1;
						var record = A2(_elm_lang$core$Basics$max, model.score, model.record);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{snakeModel: sModel, score: 0, record: record}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$SnakeMsg, cmd)
						};
					}
				} else {
					var _p5 = A2(_user$project$Snake$update, _p2._0, model.snakeModel);
					var sModel = _p5._0;
					var cmd = _p5._1;
					return {
						ctor: '_Tuple2',
...
var _user$project$Main$SetDebug = function (a) {
	return {ctor: 'SetDebug', _0: a};
};
var _user$project$Main$debugOption = F2(
	function (model, val) {
		return A2(
			_elm_lang$html$Html$input,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$SetDebug(val)),
					_1: {
						ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'active',
												_1: _elm_lang$core$Native_Utils.eq(model.debug, val)
											},
											_1: {ctor: '[]'}
										}
									}
...
var _user$project$Main$debugToggle = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$for('debug'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Main$debugOption, model, true),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$debugOption, model, false),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$Main$SetViewMode = function (a) {
	return {ctor: 'SetViewMode', _0: a};
};
var _user$project$Main$viewModeOption = F2(
	function (model, viewMode) {
		return A2(
			_elm_lang$html$Html$input,
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$SetViewMode(viewMode)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$value(
							_elm_lang$core$Basics$toString(viewMode)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$classList(
								{
									...
									_1: {
										...
										_1: {
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'active',
												_1: _elm_lang$core$Native_Utils.eq(model.viewMode, viewMode)
											},
											_1: {ctor: '[]'}
										}
									}
...
var _user$project$Main$viewModeSelector = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$for('view-mode'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('View mode'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Main$viewModeOption, model, _user$project$Main$Canvas),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$viewModeOption, model, _user$project$Main$Grid),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$Main$speedOption = F2(
		...
		return A2(
			_elm_lang$html$Html$input,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$SetSpeed(speed)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$value(
									...
									_1: {
										...
										_1: {
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'active',
												_1: _elm_lang$core$Native_Utils.eq(model.speed, speed)
											},
											_1: {ctor: '[]'}
										}
									}
...
var _user$project$Main$speedSelector = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$for('speed'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Main$speedOption, model, _user$project$Main$Slow),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$speedOption, model, _user$project$Main$Fast),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Main$speedOption, model, _user$project$Main$Mindblowing),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _user$project$Main$settings = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$viewModeSelector(model),
			_1: {
				ctor: '::',
				_0: _user$project$Main$speedSelector(model),
				_1: {
					ctor: '::',
					_0: _user$project$Main$debugToggle(model),
					_1: {ctor: '[]'}
				}
			}
		});
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					_user$project$Main$statusPart,
					'Record',
					_user$project$Main$record(model)),
				_1: {
					ctor: '::',
					_0: A2(
						_user$project$Main$statusPart,
						'Settings',
						_user$project$Main$settings(model)),
					_1: {ctor: '[]'}
				}
			}
		});
	var display = function () {
		var _p6 = model.viewMode;
		if (_p6.ctor === 'Grid') {
			return _user$project$Snake_GridView$view;
		} else {
			return _user$project$Snake_CanvasView$view;
		}
	}();
	var snakeView = A2(
		_elm_lang$html$Html$map,
		_user$project$Main$SnakeMsg,
		display(model.snakeModel));
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Main$view = function (model) {
	var inspector = _user$project$Main$modelInspector(model);
	var baseView = {
		ctor: '::',
		_0: _user$project$Main$gameView(model),
		_1: {
			ctor: '::',
			_0: inspector,
			_1: {ctor: '[]'}
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$rowLayout(baseView),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Time$every, _user$project$Main$tickTime, _user$project$Main$Clock),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Main$SnakeMsg,
					_user$project$Snake$subscriptions(model.snakeModel)),
				_1: {ctor: '[]'}
			}
		});
};
